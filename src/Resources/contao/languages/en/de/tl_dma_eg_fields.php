...
$GLOBALS['TL_LANG']['tl_dma_eg_fields']['default'] = array('Vorgabe', 'Vorgabewert des Feldes');
$GLOBALS['TL_LANG']['tl_dma_eg_fields']['eval_mandatory'] = array('Pflichtfeld', 'Das Feld muss ausgefüllt werden');
$GLOBALS['TL_LANG']['tl_dma_eg_fields']['eval_rgxp'] = array('Bedingung', 'Welche Bedingung soll die Eingabe erfüllen?');
...
$GLOBALS['TL_LANG']['tl_dma_eg_fields']['eval_tl_class'] = array('Klassen', 'Folgende Klassen dem Feld zuweisen');
