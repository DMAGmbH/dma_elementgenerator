...
$GLOBALS['TL_LANG']['tl_dma_eg']['category'] = array('Kategorie', 'Unter welcher Überschrift soll das Element in der Modul/Contenelemetliste geführt werden?');
...
$GLOBALS['TL_LANG']['tl_dma_eg']['content'] = array('Als Contentelement bereitstellen', 'Soll das Element als Contentelement zur Verfügung stehen?');
